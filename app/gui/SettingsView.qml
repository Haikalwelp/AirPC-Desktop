...
Flickable {
    ...
    Column {
        ...
        GroupBox {
            ...
            width: (parent.width - (parent.leftPadding + parent.rightPadding))
            padding: 12
            title: "<font color=\"skyblue\">" + qsTr("AirPC Streaming Enhancements") + "</font>"
            font.pointSize: 12
        ...
        GroupBox {
            ...
            Column {
                ...
                CheckBox {
                    ...
                    width: parent.width
                    text: qsTr("Mute audio stream when AirPC is not the active window")
                    font.pointSize: 12
                    visible: SystemProperties.hasDesktopEnvironment
                    ...
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Mutes AirPC's audio when you Alt+Tab out of the stream or click on a different window.")
                }
            }
        }
                    ...
                    onActivated : {
                        ...
                        if (StreamingPreferences.language !== new_language) {
                            ...
                            if (!StreamingPreferences.retranslate()) {
                                ToolTip.show(qsTr("You must restart AirPC for this change to take effect"), 5000)
                            }
                            else {
    ...
    Column {
                ...
                Row {
                    ...
                    CheckBox {
                        ...
                        ToolTip.text: qsTr("This enables the capture of system-wide keyboard shortcuts like Alt+Tab that would normally be handled by the client OS while streaming.") + "\n\n" +
                                      qsTr("NOTE: Certain keyboard shortcuts like Ctrl+Alt+Del on Windows cannot be intercepted by any application, including AirPC.")
                    }
        ...
        GroupBox {
            ...
            Column {
                ...
                CheckBox {
                    ...
                    width: parent.width
                    text: qsTr("Process gamepad input when AirPC is in the background")
                    font.pointSize: 12
                    visible: SystemProperties.hasDesktopEnvironment
                    ...
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Allows AirPC to capture gamepad inputs even if it's not the current window in focus")
                }
            }
        }
        ...
        GroupBox {
            ...
            width: (parent.width - (parent.leftPadding + parent.rightPadding))
            padding: 12
            title: "<font color=\"skyblue\">" + qsTr("AirPC Features") + "</font>"
            font.pointSize: 12
