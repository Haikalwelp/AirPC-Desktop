...
VERSION=$VERSION linuxdeployqt $DEPLOY_FOLDER/usr/share/applications/com.airpc_desktop.AirPC.desktop -qmldir=$SOURCE_ROOT/app/gui -appimage || fail "linuxdeployqt failed!"
popd
